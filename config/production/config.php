...
$config['config_cloud_db'] = array(
                                'dsn'=>'mysql:host=10.168.243.162;port=4004;dbname=config_cloud',
                                'username'=>'config',
                                'password'=>'WpR0xksGtcKtAf9hkNF2WgnnD770zV',
                                'charset'=>'utf8',
                            );
//IOP数据库配置
$config['iop_db'] = array('dsn'=>'mysql:host=10.168.243.162;port=4004;dbname=iop',
								'username'=>'iop',
								'password'=>'mxjwcqogN43ob8iVjlYPdjY0yUinDg',
								'charset'=>'utf8',
							);
//I2P数据库配置
$config['i2p_db'] = array('dsn'=>'mysql:host=10.168.243.162;port=4004;dbname=i2p',
								'username'=>'i2p_iop',
								'password'=>'hJd7dgVKgXmamFs2du8CJZJlaoDnOL',
								'charset'=>'utf8',
							);
//park_cloud数据库配置
$config['park_cloud_db'] = array('dsn'=>'mysql:host=10.168.243.162;port=4004;dbname=park_cloud',
								'username'=>'reader',
...
//inside_cars数据库配置
$config['inside_cars_db'] = array('dsn'=>'mysql:host=127.0.0.1;port=13307;dbname=inside_cars',
								'username'=>'iop',
								'password'=>'iop1q2w3e',
								'charset'=>'utf8',
							);
//ebills数据库配置
$config['ebills_db'] = array('dsn'=>'mysql:host=10.168.243.162;port=4004;dbname=ebills',
								'username'=>'reader',
								'password'=>'pds3G1W0fdbiF3ivQRU9KnCgJ3W065',
								'charset'=>'utf8',
							);                             
...
$config['rabbitmq_param'] = array('host'=>'127.0.0.1',
									...
									'password' => 'guest',
									'vhost'=>'/',
									'exchange_name'=>'arm_msg_broadcast',
									'route_key'=>'arm_msg_broadcast',
...
$config['pay_rabbitmq_param'] = array(
                                ...
                                'password' => 'guest',
                                'vhost'=>'/',
                                'exchange_name'=>'bill_collector',
                                'route_key'=>'bill_collector',
...
//base url
$config['base_url'] = 'http://121.41.119.188:9523';
//进出车图片域名配置
